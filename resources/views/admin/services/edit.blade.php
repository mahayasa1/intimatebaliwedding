            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        <option value="{{ $package->id }}" {{ old('package_id', $service->package_id) == $package->id ? 'selected' : '' }}>
                            {{ $package->name }}
                        </option>
                        @endforeach
                    </select>
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                <label for="foto" class="form-label">
                    {{ $service->foto ? 'Replace Image (Optional)' : 'Upload Image' }}
                </label>
                ...
                @enderror
                <div class="form-help">
                    {{ $service->foto ? 'Leave empty to keep current image. ' : '' }}Maximum file size: 2MB. Supported formats: JPEG, PNG, WEBP
                </div>
            </div>
        </div>
