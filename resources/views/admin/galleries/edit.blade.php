...
<style>
    ...
    /* New image preview */
    .image-new-preview { display: none; margin-top: 1rem; }
...
<div class="form-container">
    <form action="{{ route('admin.galleries.update', $gallery) }}" method="POST" enctype="multipart/form-data" id="editForm">
        ...
        <div class="form-card" id="photoSection" style="{{ ($gallery->type ?? '') === 'video' ? 'display:none;' : '' }}">
            ...
            <div class="form-group">
                <label class="form-label">{{ $gallery->image ? 'Ganti Foto Utama (Opsional)' : 'Upload Foto Utama' }}</label>
                <div class="upload-area" id="mainImageArea">
                    <input type="file" id="mainImageInput" name="foto"
                        accept="image/jpeg,image/png,image/jpg,image/webp">
                    <div class="upload-icon"><i class="fas fa-cloud-upload-alt"></i></div>
                    <div class="upload-text">
                        <strong>Click to upload</strong> atau drag & drop
                    </div>
                    <div style="font-family:'Work Sans',sans-serif;color:#aaa;font-size:0.8rem;margin-top:0.25rem;">
                        {{ $gallery->image ? 'Kosongkan jika tidak ingin mengganti' : 'JPG, PNG, WEBP · Max 30MB' }}
                    </div>
                </div>
                ...
                <div class="image-new-preview" id="mainImgPreview">
        ...
        <div class="form-card" id="photosSection" style="{{ ($gallery->type ?? '') === 'video' ? 'display:none;' : '' }}">
            ...
            <div class="form-group">
                ...
                <div class="upload-area" id="photosArea">
                    ...
                    <div class="upload-text"><strong>Click to upload</strong> multiple foto baru</div>
                    <div style="font-family:'Work Sans',sans-serif;color:#aaa;font-size:0.8rem;margin-top:0.25rem;">
                ...
                <div class="photos-grid" id="newPhotosGrid" style="display:none; margin-top:1rem;"></div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderNewPhotos() {
        ...
        if (!photoFiles.length) { newPhotosGrid.style.display = 'none'; return; }
        newPhotosGrid.style.display = 'grid';
