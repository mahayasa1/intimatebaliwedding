        ...
        <div class="form-card">
            ...
            <div class="current-photo">
                ...
                <div class="photo-info">
                    <div class="photo-info-item">
                        ...
                        <span>{{ basename($gallery->foto) }}</span>
                    </div>
                </div>
            </div>
            @endif
            ...
            <div class="form-group">
                <label for="foto" class="form-label">
                    {{ $gallery->foto ? 'Replace Photo (Optional)' : 'Upload Photo' }}
                </label>
                ...
                <div class="form-help">
                    <i class="fa-solid fa-circle-info"></i>
                    {{ $gallery->foto ? 'Leave empty to keep current photo. ' : '' }}Maximum file size: 2MB. Supported formats: JPEG, PNG, WEBP
                </div>
            </div>
        </div>
